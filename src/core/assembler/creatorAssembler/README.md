# CREATOR Assembler
The source code is located at [creatorsim/creator-assembler](https://github.com/creatorsim/creator-assembler) (specifically, version 2), and must be built for both the CLI and Web versions.
