 ...
 *
 */
import { main_memory, status, update_binary, architecture, backup_stack_address, backup_data_address, newArchitecture, ENDIANNESSARR, WORDSIZE, BYTESIZE } from "../../core.mjs";
import { creator_ga } from "../../utils/creator_ga.mjs";
import { set_tag_instructions, writeMultiByteValueAsWords, setAddress, setInstructions, formatErrorWithColors } from "../compiler.mjs";
