...
export const creatorDarkTheme: monaco.editor.IStandaloneThemeData = {
    ...
    rules: [
        ...
        { token: "identifier", foreground: "dee2e6" },
    ...
    colors: {
        ...
        "editor.foreground": "#dee2e6",
        "editorCursor.foreground": "#dee2e6",
        "editor.lineHighlightBackground": "#2c3034",
        "editor.selectionBackground": "#495057",
        "editorLineNumber.foreground": "#6c757d",
        "editorLineNumber.activeForeground": "#adb5bd",
        "editorGutter.background": "#1a1d21",
        "editorIndentGuide.background": "#343a4020",
