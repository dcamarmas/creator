/**
 * Z80 Assembly Language Definition for Monaco Editor
 * 
 * Custom language definition for Z80 assembly with specific syntax highlighting
 * and completion support tailored to Z80's unique instruction set and addressing modes.
 */
...
export const z80TokensProvider: monaco.languages.IMonarchLanguage = {
  ...
  directives: [
    "org", "equ", "db", "dw", "ds", "defb", "defw", "defs",
    "byte", "word", "include", "incbin", "macro", "endm",
    "if", "ifdef", "ifndef", "else", "endif",
    "align", "fill", "assert", "print",
  ],
...
export function createZ80CompletionProvider(): monaco.languages.CompletionItemProvider {
  return {
    provideCompletionItems: (model, position) => {
      ...
      const registers = ["a", "b", "c", "d", "e", "h", "l", "i", "r", "ixh", "ixl", "iyh", "iyl"]
      const registerPairs = ["af", "bc", "de", "hl", "sp", "ix", "iy", "af'"]
...
export function registerZ80Language() {
  ...
  monaco.languages.registerCompletionItemProvider("z80", createZ80CompletionProvider())
}
