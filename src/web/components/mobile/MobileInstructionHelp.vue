  ...
  computed: {
    ...
    filteredInstructions() {
      ...
      return this.instructions.filter(instruction =>
        ...
        (instruction.help && instruction.help.toLowerCase().includes(filter)) ||
...
<template>
  <b-modal :id="id" class="bottomCard" title="Instruction Help" size="lg" centered scrollable>
    <b-form-input
    ...
    <a v-if="architecture_guide" target="_blank" :href="architecture_guide" class="d-block mb-3">
    ...
    <div class="instruction-list">
      ...
      <div v-if="filteredInstructions.length === 0" class="text-center text-muted">
