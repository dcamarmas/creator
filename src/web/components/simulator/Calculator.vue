    ...
    calculatorFunct(index) {
      switch (index) {
        case 0:
          ...
          const hex = this.calculator.hexadecimal.padStart(this.calculator.bits / 4, '0')
          let float
          let binary
        ...
        case 1:
          if (this.calculator.bits === 32) {
            ...
            const binary =
              this.calculator.sign + this.calculator.exponent + this.calculator.mantissa
            console_log(binary)
...
<template>
  <b-modal :id="id" title="Floating Point Calculator" hide-footer size="lg">
    ...
    <b-container fluid align-h="start" class="mx-0 px-0">
      <b-row cols="1" align-h="start">
        <b-col lg="8" offset-lg="1" class="p-1">
          <b-img class="calculatorImg" src="./images/calculator.png" fluid alt="calculator" />
        </b-col>
      </b-row>
    </b-container>
      ...
      <b-row cols="4" align-h="start">
        ...
        <b-col lg="3" cols="4" class="p-1">
          ...
          <span class="h5" v-if="calculator.bits == 32">
            ...
            <sup
              v-if="
                calculator.exponent != '' && calculator.exponent == 0 && calculator.mantissa != 0
              "
            >
