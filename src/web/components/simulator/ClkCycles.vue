...
<script>
import PlotClkCycles from './PlotClkCycles.vue'
import TableClkCycles from './TableClkCycles.vue'
    ...
    <b-row cols="1">
      <b-col align-h="center" class="px-2 my-2">
        <PlotClkCycles
          ...
          v-if="clk_cycles_representation === 'graphic'"
        />
        <TableClkCycles :clk_cycles="clk_cycles" v-if="clk_cycles_representation === 'table'" />
      </b-col>
    </b-row>
  </b-container>
</template>
