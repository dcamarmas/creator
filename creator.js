...
var creator_version = JSON.parse(
...
var argv = require('yargs')
    ...
    .demandOption(
        ...
        'Please provide both architecture and assembly files.'
    )
    .help('h')
    .alias('h', 'help').argv;
...
function one_file(
    ...
    try {
        ...
        ret1.Architecture = {
            status: 'ok',
            msg: "Architecture '" + argv.a + "' loaded successfully.",
        };
    } catch (e) {
    ...
    if (argv_library !== '') {
        try {
            ...
            ret1.Library = {
                status: 'ok',
                msg: "Code '" + argv.l + "' linked successfully.",
            };
        } catch (e) {
    ...
    try {
        ...
        ret1.Compile = {
            status: 'ok',
            msg: "Code '" + argv.s + "' compiled successfully.",
        };
    } catch (e) {
    ...
    if (argv_result !== '') {
        ...
        if (ret.msg !== '') ret1.LastState = { status: 'ko', msg: ret.msg };
