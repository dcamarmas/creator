 ...
 */
				...
				template: ' <b-button class="btn btn-outline-secondary btn-block btn-sm registers h-100" ' +
									'           :id="popoverId(register.name + \'DFP\')" ' +
									...
									'   	{{bin2hex(double2bin(register.value))}}' +
									' 	</b-badge>' +
									' </b-button>' +
									' ' +
									' <popover-register-double :target="popoverId(register.name + \'DFP\')" ' +
									'                          :component="component"' +
									'                          :register="register">' +
				...
				Vue.component('register-double', uielto_register_double) ;
