  ...
  var uielto_arch_conf = {
        ...
        methods:    {
                      ...
                      edit_arch_field_modal(field, index, button){
                        app._data.modalEditArchField.title = "Edit " + field; //TODO: bidirectional
                        app._data.modalEditArchField.field = field; //TODO: bidirectional
                        app._data.modalEditArchField.value = this._props.arch_conf[index].value; //TODO: bidirectional
                        app._data.modalEditArchField.index = index; //TODO: bidirectional
                      ...
                      reset_arch_field_modal(field, index, button){
                        ...
                        app._data.modalResetArchField.index = index; //TODO: bidirectional
        ...
        template:   '<div class="col-lg-12 col-sm-12 row memoryLayoutDiv">' +
                    ...
                    '        <span v-if="row.item.name == \'Name\' || row.item.name == \'Bits\' || row.item.name == \'Main Function\'">{{row.item.value}}</span>' +
