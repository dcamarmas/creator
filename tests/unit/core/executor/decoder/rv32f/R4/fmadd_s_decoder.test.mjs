...
Deno.test("decode_instruction - FMADD.S instruction 1", () =>
    decode_test("00011000001000001000000001000011", "fmadd.s f0 f1 f2 f3 rne"),
);

Deno.test("decode_instruction - FMADD.S instruction 2", () =>
    decode_test("00111000011000101001001001000011", "fmadd.s f4 f5 f6 f7 rtz"),
);

Deno.test("decode_instruction - FMADD.S instruction 3", () =>
    decode_test(
...
Deno.test("decode_instruction - FMADD.S instruction 4", () =>
    decode_test(
...
Deno.test("decode_instruction - FMADD.S instruction 5", () =>
    decode_test(
...
Deno.test("decode_instruction - FMADD.S instruction 13", () =>
    decode_test(
...
Deno.test("decode_instruction - FMADD.S instruction 14", () =>
    decode_test(
...
Deno.test("decode_instruction - FMADD.S instruction 15", () =>
    decode_test(
...
Deno.test("decode_instruction - FMADD.S instruction 16", () =>
    decode_test("00001001011010110111101101000011", "fmadd.s f22 f22 f22 f1"),
);

Deno.test("decode_instruction - FMADD.S instruction 17", () =>
    decode_test("00011000001100011111000111000011", "fmadd.s f3 f3 f3 f3"),
);

Deno.test("decode_instruction - FMADD.S instruction 18", () =>
